...
let slider31 =
    /** @type{HTMLInputElement} */
    document.getElementById("box3-slider1");
/** @type{HTMLInputElement} */
let slider32 =
    /** @type{HTMLInputElement} */
    document.getElementById("box3-slider2");
...
if (slider31 && slider32 && slider33) {
    ...
    slider31.onchange = function() {
        document.getElementById(
            "box3-li1"
        ).innerHTML = `Slider 1 - <b>onchange</b> - new value ${slider31.value}`;
    };
    slider32.oninput = function() {
        document.getElementById(
            "box3-li2"
        ).innerHTML = `Slider 2 - <b>oninput</b> - new value ${slider32.value}`;
    };
    slider33.onclick = function() {
        document.getElementById(
            "box3-li3"
        ).innerHTML = `Slider 3 - <b>onclick</b> - new value ${slider33.value}`;
    };
}